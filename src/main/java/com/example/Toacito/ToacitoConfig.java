...
public interface ToacitoConfig extends Config {
    ...
    default boolean pikachusConfig() {
        return true;
    }
    ...
    default boolean pantheonConfig() {
        return true;
    }
}
